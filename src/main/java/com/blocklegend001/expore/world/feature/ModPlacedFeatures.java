...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> NETHER_EXP_ORE_PLACED = createKey("nether_exp_ore_placed");
    public static final ResourceKey<PlacedFeature> END_EXP_ORE_PLACED = createKey("end_exp_ore_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, EXP_PLACED_KEY, configuredFeatures.getOrThrow(ModConfiguredFeatures.OVERWORLD_EXP_ORE_KEY),
                commonOrePlacement(12,
                        HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(-63), VerticalAnchor.absolute(80))));

        register(context, NETHER_EXP_ORE_PLACED, configuredFeatures.getOrThrow(ModConfiguredFeatures.NETHER_EXP_ORE_KEY),
                commonOrePlacement(12,
                        HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(0), VerticalAnchor.absolute(125))));

        register(context, END_EXP_ORE_PLACED, configuredFeatures.getOrThrow(ModConfiguredFeatures.END_EXP_ORE_KEY),
                commonOrePlacement(12,
