...
public class ModBlocks {
    ...
    private static Block registerBlock(String name, Block block, ItemGroup tab) {
        ...
        return Registry.register(Registry.BLOCK, new Identifier(ExpOre.MOD_ID, name), block);
    }

    private static Item registerBlockItem(String name, Block block, ItemGroup tab) {
        return Registry.register(Registry.ITEM, new Identifier(ExpOre.MOD_ID, name),
                new BlockItem(block, new FabricItemSettings().group(tab)));
    }

    public static void registerModBlocks() {
        ExpOre.LOGGER.debug("Registering ModBlocks for " + ExpOre.MOD_ID);
    }
}
